 ...
 */
@Entity
@Table(name = "funcionario", catalog = "amamentai-api", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class Funcionario implements Serializable {
    ...
    public Funcionario(Integer id, boolean ativo) {
        this.id = id;
        this.ativo = ativo;
    }
    ...
    public String toString() {
        return "com.example.amamentai.api.model.Funcionario[ id=" + id + " ]";
    }
